...
describe("files", function() {
  describe("#Saving base64", function(){
    ...
    it("should be saved", function(done){
      ...
      var file = new LC.File("myfile.txt", { base64: base64 });
      file.metaData('format', 'txt file');
      file.setACL(new LC.ACL());
  ...
  describe("#Test withURL", function(){
    ...
    it("should be saved", function(done){
      ...
      var file = LC.File.withURL('screen.jpg', url);
      file.save().then(function(){
        // console.log(file.url());
        // console.log(file.id);
        expect(file.ownerId()).to.be.ok();
  ...
  describe("#Saving buffer in node.js", function(){
    it("should be saved", function(done){
      if(LC._isNode){
        var file = new LC.File('myfile.txt', new Buffer('hello world'));
        file.save().then(function(){
  ...
  describe("#Saving array", function(){
    it("should be saved", function(done){
      ...
      var file = new LC.File("myfile.txt", bytes);
      file.save().then(function(){
        // console.log(file.url());
        // console.log(file.id);
        // console.log(file.metaData());
