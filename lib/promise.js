...
_.extend(Promise, /** @lends LC.Promise */ {
   ...
   * @return {LC.Promise} the new promise.
   */
  as: function() {
   ...
   *   var p1 = LC.Promise.as(1);
   *   var p2 = LC.Promise.as(2);
   *   var p3 = LC.Promise.as(3);
   *
   *   LC.Promise.when(p1, p2, p3).then(function(r1, r2, r3) {
   ...
   *   LC.Promise.when(promises).then(function(r1, r2, r3) {
   *     console.log(r1);  // prints 1
   *     console.log(r2);  // prints 2
   *     console.log(r3);  // prints 3
   *   });
   ...
   *   var p3 = LC.Promise.as(3);
   *
   *   LC.Promise.race(p1, p2, p3).then(function(result) {
   *     console.log(result);  // prints 1
   *   });</pre>
   *
   * The input promises can also be specified as an array: <pre>
   *   var promises = [p1, p2, p3];
   *   LC.Promise.when(promises).then(function(result) {
   *     console.log(result);  // prints 1
   *   });
   * </pre>
   * @param {Array} promises a list of promises to wait for.
...
/**
 * Just like LC.Promise.when, but it calls resolveCallbck function
...
_.extend(Promise.prototype, /** @lends LC.Promise.prototype */ {
   ...
   * @return {LC.Promise} A new Promise that will be fulfilled after this
   ...
   * @return {LC.Promise} A promise that will be resolved after the
...
/**
 * Alias of LC.Promise.prototype.always
 * @function
 * @see LC.Promise#always
 */
Promise.prototype.finally = Promise.prototype.always;

/**
 * Alias of LC.Promise.prototype.done
 * @function
 * @see LC.Promise#done
 */
