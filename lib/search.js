...
module.exports = function(LC) {
   ...
   * <pre><code>
   *   var builder = new LC.SearchSortBuilder();
   *   builder.ascending('key1').descending('key2','max');
   *   var query = new LC.SearchQuery('Player');
   ...
   * @since 0.5.1
   */
  LC.SearchSortBuilder = function() {
    this._sortFields = [];
  };

  LC.SearchSortBuilder.prototype = {
     ...
     * @return {LC.SearchSortBuilder} Returns the builder, so you can chain this call.
     */
     ...
     */
    build: function() {
      return JSON.stringify(LC._encode(this._sortFields));
    }
  };

  /**
   * App searching query.Use just like LC.Query:
   * <pre><code>
   *   var query = new LC.SearchQuery('Player');
   *   query.queryString('*');
   ...
   *
   * </code></pre>
   * Visite <a href='https://leap.as/docs/app_search_guide.html'>App Searching Guide</a>
   * for more details.
   * @class
   * @since 0.5.1
   *
   */
  LC.SearchQuery = LC.Query._extend(/** @lends LC.SearchQuery.prototype */{
     _sid: null,
     _hits:  0,
     _queryString: null,
     _highlights: null,
    ...
    _createRequest: function(params){
      return LC._request("search/select", null, null, "GET",
                                   params || this.toJSON());
    },
     ...
     * @return {LC.SearchQuery} Returns the query, so you can chain this call.
     */
    sid: function(sid) {
      this._sid = sid;
      return this;
     ...
     * @see LC.SearchSortBuilder
     * @param { LC.SearchSortBuilder} builder The sort builder.
     * @return {LC.SearchQuery} Returns the query, so you can chain this call.
     *
     */
    ...
    toJSON: function(){
      var params = LC.SearchQuery.__super__.toJSON.call(this);
      delete params.where;
      if(this.className) {
