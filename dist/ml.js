...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(23)(ML);
	__webpack_require__(24)(ML);
	__webpack_require__(25)(ML);
	__webpack_require__(26)(ML);
	__webpack_require__(27)(ML);
	__webpack_require__(28)(ML);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ML) {
	  ...
	  ML.initialize = function (applicationId, applicationKey, masterKey) {
	    if (masterKey) {
	      throw new Error("ML.initialize() was passed a Master Key, which is only " + "allowed from within Node.js.");
	    }
	  ...
	  ML._initialize = function (applicationId, applicationKey, masterKey) {
	    if (ML.applicationId !== undefined && applicationId !== ML.applicationId && applicationKey !== ML.applicationKey && masterKey !== ML.masterKey) {
	  ...
	  ML._getInstallationId = function () {
	    ...
	    if (!ML._installationId || ML._installationId === "") {
	      ...
	      ML._installationId = hexOctet() + hexOctet() + "-" + hexOctet() + "-" + hexOctet() + "-" + hexOctet() + "-" + hexOctet() + hexOctet() + hexOctet();
	  ...
	  ML._ajax = function (method, url, data, success, error, headers) {
	    ...
	    if (ML._isNode) {
	      ...
	      xhr.setRequestHeader("User-Agent", "ML/" + ML.VERSION + " (NodeJS " + process.versions.node + ")");
	    }
	    xhr.send(data);
	  ...
	  ML._request = function (route, className, objectId, method, dataObject, headers) {
	    ...
	    if (route !== "batch" && route !== "classes" && route !== "files" && route !== "functions" && route !== "login" && route !== "marketing/push/msg" && route !== "search/select" && route !== "requestPasswordReset" && route !== "requestEmailVerify" && route !== "requestPasswordResetBySmsCode" && route !== "resetPasswordBySmsCode" && route !== "requestMobilePhoneVerify" && route !== "requestLoginSmsCode" && route !== "loginByMobilePhone" && route !== "verifyMobilePhone" && route !== "requestSmsCode" && route !== "verifySmsCode" && route !== "users" && route !== 'updatePassword' && route !== "usersByMobilePhone" && route !== "cloudQuery" && route !== "statuses" && route !== "bigquery" && route !== 'search/select' && route !== 'subscribe/statuses/count' && route !== 'subscribe/statuses' && !/users\/[^\/]+\/updatePassword/.test(route) && !/users\/[^\/]+\/friendship\/[^\/]+/.test(route)) {
	    ...
	    if (!(data instanceof File)) {
	      ...
	      if (ML._useMasterKey) dataObject._MasterKey = ML.masterKey;
	  ...
	  ML._encode = function (value, seenObjects, disallowObjects) {
	    ...
	    if (value instanceof ML.Object) {
	      ...
	      if (!value.dirty()) {
	        ...
	        return ML._encode(value._toFullJSON(seenObjects), seenObjects, disallowObjects);
	      }
	      ...
	      var pointerToId = function pointerToId(object) {
	        if (object instanceof ML.Object) {
	          ...
	          if (self._targetClassName !== object.className) {
	            throw "Tried to create a ML.Relation with 2 different types: " + self._targetClassName + " and " + object.className + ".";
	          }
	          return object.id;
	        }
	        return object;
	...
	module.exports = function (ML) {
	  ...
	  /** @lends ML.Object.prototype */{
	    ...
	    toJSON: function toJSON() {
	      ...
	      ML._arrayEach(["__type", "className"], function (key) {
	        delete json[key];
	      });
	      return json;
	    },
	    ...
	    *   });
	    ...
	    set: function set(key, value, options) {
	      ...
	      ML._arrayEach(_.keys(attrs), function (attr) {
	        ...
	        if (val instanceof ML.Op.Set && _.isEqual(self.attributes[attr], val.value)) {
	          isRealChange = false;
	        }
	    ...
	    fetch: function fetch() {
	      ...
	      var self = this;
	      var request = ML._request("classes", this.className, this.id, 'GET', fetchOptions);
	    ...
	    *   });</pre>
	    ...
	    save: function save(arg1, arg2, arg3) {
	      ...
	      var unsavedChildren = [];
	      var unsavedFiles = [];
	      ML.Object._findUnsavedChildren(model.attributes, unsavedChildren, unsavedFiles);
	    ...
	    destroy: function destroy(options) {
	      ...
	      var request = ML._request("classes", this.className, this.id, 'DELETE');
	  ...
	  ML.Object.destroyAll = function (objects, options) {
	    ...
	    var request = ML._request('batch', null, null, 'POST', dataObject);
	  ...
	  ML.Object.extend = function (className, protoProps, classProps) {
	    ...
	    if (!_.isString(className)) {
	      if (className && _.has(className, "className")) {
	        ...
	        throw new Error("ML.Object.extend's first argument should be the className.");
	      }
	    }
	  ...
	  ML.Object._deepSaveAsync = function (object, model) {
	    ...
	    return promise.then(function () {
	      return ML.Promise._continueWhile(function () {
	        ...
	        if (batch.length === 0) {
	          return ML.Promise.error(new ML.Error(ML.Error.OTHER_CAUSE, "Tried to save a batch with a cycle."));
	        }
	        ...
	        return readyToStart._continueWith(function () {
	          return ML._request("batch", null, null, "POST", {
	            ...
	            ML._arrayEach(batch, function (object, i) {
	              object._finishSave(object.parse(response[i], status, xhr));
	            });
	            if (error) {
	              return ML.Promise.error(new ML.Error(error.code, error.error));
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  ...
	  _.extend(ML.CloudCode.prototype, /** @lends ML.CloudCode.prototype */{
	     ...
	     * @returns {Promise}
	     */
	    callFunctionInBackground: function callFunctionInBackground(name, data) {
	  ...
	  ML.User = ML.Object.extend("_User", /** @lends ML.User.prototype */{
	    ...
	    signUp: function signUp(attrs, options) {
	      ...
	      if (!username || username === "") {
	        error = new ML.Error(ML.Error.OTHER_CAUSE, "Cannot sign up user with an empty name.");
	        if (options && options.error) {
	      ...
	      if (!password || password === "") {
	        error = new ML.Error(ML.Error.OTHER_CAUSE, "Cannot sign up user with an empty password.");
	        if (options && options.error) {
	          options.error(this, error);
	        }
	        return ML.Promise.error(error);
	     ...
	     *     finishes.
	     */
	    anonymousSignUp: function anonymousSignUp() {
	      var model = this;
	      var authData = {
	        anonymous: {
	          id: uuid.v1()
	    ...
	    signUpOrlogInWithMobilePhone: function signUpOrlogInWithMobilePhone(attrs, options) {
	      ...
	      if (!mobilePhoneNumber || mobilePhoneNumber === "") {
	        error = new ML.Error(ML.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber " + "with an empty mobilePhoneNumber.");
	        if (options && options.error) {
	          options.error(this, error);
	        }
	        return ML.Promise.error(error);
	      ...
	      if (!smsCode || smsCode === "") {
	        error = new ML.Error(ML.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber  " + "with an empty smsCode.");
	        if (options && options.error) {
	          options.error(this, error);
	        }
	        return ML.Promise.error(error);
	    ...
	    authenticated: function authenticated() {
	      return !!this._sessionToken && ML.User.current() && ML.User.current().id === this.id;
	    }
	    ...
	    become: function become(sessionToken, options) {
	      ...
	      var user = ML.Object._create("_User");
	      return ML._request("users", "me", null, "GET", {
	    ...
	    logOut: function logOut() {
	      ...
	      ML.localStorage.removeItem(ML._getMLPath(ML.User._CURRENT_USER_KEY));
	    },
	    ...
	    requestPasswordReset: function requestPasswordReset(email, options) {
	      ...
	      var request = ML._request("requestPasswordReset", null, null, "POST", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    requestEmailVerify: function requestEmailVerify(email, options) {
	      var json = { email: email };
	      var request = ML._request("requestEmailVerify", null, null, "POST", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    requestMobilePhoneVerify: function requestMobilePhoneVerify(mobilePhone, options) {
	      ...
	      var request = ML._request("requestMobilePhoneVerify", null, null, "POST", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    requestPasswordResetBySmsCode: function requestPasswordResetBySmsCode(mobilePhone, options) {
	      var json = { mobilePhoneNumber: mobilePhone };
	      var request = ML._request("requestPasswordResetBySmsCode", null, null, "POST", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    * The sms code is sent by ML.User.requestPasswordResetBySmsCode.
	    ...
	    resetPasswordBySmsCode: function resetPasswordBySmsCode(code, password, options) {
	      ...
	      var request = ML._request("resetPasswordBySmsCode", null, code, "PUT", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    verifyMobilePhone: function verifyMobilePhone(code, options) {
	      var request = ML._request("verifyMobilePhone", null, code, "POST", null);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    requestLoginSmsCode: function requestLoginSmsCode(mobilePhone, options) {
	      ...
	      var request = ML._request("requestLoginSmsCode", null, null, "POST", json);
	      return request._thenRunCallbacks(options);
	    },
	    ...
	    current: function current() {
	      ...
	      var userData = ML.localStorage.getItem(ML._getMLPath(ML.User._CURRENT_USER_KEY));
	      if (!userData) {
	    ...
	    _saveCurrentUser: function _saveCurrentUser(user) {
	      ...
	      ML.localStorage.setItem(ML._getMLPath(ML.User._CURRENT_USER_KEY), JSON.stringify(json));
	    },
	...
	module.exports = function (ML) {
	  ...
	  ML.Query.prototype = {
	    ...
	    get: function get(objectId, options) {
	      if (!objectId) {
	        var errorObject = new ML.Error(ML.Error.OBJECT_NOT_FOUND, "Object not found.");
	    ...
	    _createRequest: function _createRequest(params) {
	      ...
	      return ML._request("classes", this.className + '/query', null, "POST", params || this.toJSON());
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ML) {
	  ...
	  _.extend(ML.Analytics.prototype, /** @lends ML.Analytics.prototype */{
	     ...
	     * @returns {Promise}
	     */
	    trackPageBegin: function trackPageBegin() {
	      var data = {
	        PageView: [_.extend({}, this.options, {
	          uuid: uuid.v4()
	        })]
	      };
	     ...
	     * @returns {Promise}
	     */
	    trackEvent: function trackEvent(eventId, attrs) {
	      var data = {
	        Event: [_.extend({}, this.options, {
	          eventId: eventId,
	          attrs: attrs,
	          uuid: uuid.v4()
	        })]
	     ...
	     * @returns {Promise}
	     */
	    trackUserlogin: function trackUserlogin(data) {
	      var data = {
	        TimeLineEvent: [_.extend({}, this.options, {
	     ...
	     * @returns {Promise}
	     */
	    trackUserRegister: function trackUserRegister(data) {
	      var data = {
	        TimeLineEvent: [_.extend({}, this.options, {
	          eventId: data.eventId,
	          eventName: this.UNKNOWN,
	     ...
	     * @returns {Promise}
	     */
	    trackUserLogout: function trackUserLogout(data) {
	      var data = {
	        TimeLineEvent: [_.extend({}, this.options, {
	          eventId: data.eventId,
	          eventName: this.UNKNOWN,
	     ...
	     * @returns {Promise}
	     */
	    trackSessionStart: function trackSessionStart(data) {
	      var data = {
	        TimeLineEvent: [_.extend({}, this.options, {
	          eventId: data.eventId,
	          eventName: this.UNKNOWN,
	     ...
	     * @returns {*|Promise}
	     */
	    trackOriginEvent: function trackOriginEvent(data) {
	      return ML.Analytics._request(data, { appId: this.options.appId }, {
	        url: '2.0/track/event'
	      });
	    },
	     ...
	     * @returns {Promise}
	     */
	    _trackSessionBegin: function _trackSessionBegin() {
	      var data = {
	        Session: [_.extend({}, this.options, {
	          uuid: uuid.v4()
	        })]
	      };
	      return ML.Analytics._request(data, { appId: this.options.appId });
	     ...
	     * @returns {Promise}
	     */
	    _trackTimelineSession: function _trackTimelineSession() {
	      var data = [{
	     ...
	     * @returns {Promise}
	     */
	    _trackNewUser: function _trackNewUser() {
	      var data = {
	        NewUser: [_.extend({}, this.options, {
	          uuid: uuid.v4()
	        })]
	      };
	      return ML.Analytics._request(data, { appId: this.options.appId });
	  ...
	  _.extend(ML.Analytics, /** @lends ML.Analytics */{
	     ...
	     * @private
	     */
	    _request: function _request(data, headers, options, i) {
	      options = options || {};
